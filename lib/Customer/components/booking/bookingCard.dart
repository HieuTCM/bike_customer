...
class BookingFishedCard extends StatelessWidget {
  final FinishedTrip? trip;
  BookingFishedCard({this.trip});
  @override
          ...
          children: <Widget>[
            ...
            Row(
              children: [
                ...
                Text(trip!.cusTrip.createDate.toString().substring(0, 10),
                    ...
                    Row(children: [
                      Text("\u2022   " + "From: ",
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              color: Color.fromARGB(255, 0, 0, 0))),
                      Text(trip!.cusTrip.pickupStation.name)
                    ]),
                    Row(
                      children: [
                        Text("\u2022   " + "To: ",
                            style: TextStyle(
                                fontWeight: FontWeight.bold,
                                color: Color.fromARGB(255, 0, 0, 0))),
                        Text(trip!.cusTrip.headtoStation.name)
                      ],
                    ),
                  ],
                )),
