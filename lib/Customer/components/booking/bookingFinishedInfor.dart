...
class bookingFinishedInfo extends StatefulWidget {
  FinishedTrip trip;
  bookingFinishedInfo(this.trip);
  @override
  State<bookingFinishedInfo> createState() => _bookingFinishedInfoState();
}

class _bookingFinishedInfoState extends State<bookingFinishedInfo> {
  cancelTrip() async {
  ...
  insCustomerTrip() async {
    CustomerTrip trip = new CustomerTrip(
      slotId: widget.trip.cusTrip.slot.id,
      routeId: widget.trip.cusTrip.route.id,
      customerId: widget.trip.cusTrip.customerId.toString(),
      pickupStationId: widget.trip.cusTrip.pickupStation.id.toString(),
      headtoStationId: widget.trip.cusTrip.headtoStation.id.toString(),
      amount: widget.trip.amount.toString(),
      pickupTime: widget.trip.cusTrip.pickupTime.toString(),
    );
                                ...
                                Column(
                                    ...
                                    children: <Widget>[
                                        ...
                                        const Text("From: ",
                                            style: TextStyle(
                                                ...
                                                color: Color.fromARGB(
                                                    255, 0, 0, 0))),
                                        Text(
                                            widget.trip.cusTrip.pickupStation
                                                .name,
                                      ...
                                      Row(children: [
                                        ...
                                        Text(
                                            widget.trip.cusTrip.headtoStation
                                                .name,
                                            style: const TextStyle(
                                                fontSize: 16,
                                                color: Color.fromARGB(
                                        ...
                                        children: [
                                          Text("Slot: ",
                                              style: TextStyle(
                                                  ...
                                                  color: Color.fromARGB(
                                                      255, 0, 0, 0))),
                                          Text(widget.trip.cusTrip.slot.name,
                                              style: TextStyle(
                                                  fontSize: 16,
                                                  color: Color.fromARGB(
                                                      255, 0, 0, 0)))
                                          ...
                                          Text("PickUp Time: ",
                                              style: TextStyle(
                                                  ...
                                                  color: Color.fromARGB(
                                                      255, 0, 0, 0))),
                                          Text(
                                              widget.trip.cusTrip.pickupTime
                                                  .toString()
                                                  .substring(0, 5),
                                              style: TextStyle(
                                                  fontSize: 16,
